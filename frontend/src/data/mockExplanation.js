  ...
  blocks: [
    {
      ...
      purpose: "Defines the primary function entry point.",
    ...
    },
    {
      ...
      purpose: "Initializes boundaries for binary search range.",
    ...
    },
    {
      ...
      purpose: "Repeatedly narrows the search window until boundaries cross.",
    ...
    },
    {
      ...
      purpose: "Finds the midpoint of the active search range.",
    ...
    },
    {
      ...
      purpose: "Compares mid element with target and narrows search range.",
    ...
    },
    {
      ...
      type: "return",
      title: "Failure Case",
      purpose: "Exits with -1 if target is not found in search array.",
